...
public class Main {
    public static void main(String[] args) {
        ...
        SimplePair<Integer, String> pair = new SimplePair<Integer,String>(5, "Oliver");
        ...
        System.out.println(
            Generics.getType(1) + " " + 
            Generics.getType("Oliver") + " " + 
            Generics.getType(1.5) + " " + 
            Generics.getType('x') + " " + 
            Generics.getType(true) + " " + 
            Generics.getType(10L) + " " + 
            Generics.getType(1.99f) + " " + 
