...
public class StreamsExample {
  public static void main(String[] args) {
    ...
    //System.out.println(IntStream.of(2, 4, 6, 8, 10, 11).anyMatch(e -> e % 2 != 0));
    ...
    //IntStream.of(5, 7, 15, 28, 46, 88, 105, 333, 1024, 6751).filter(e -> e < 10).max().ifPresent(System.out::println);
    
    IntStream.of(6, 10, 15, 22, 43).filter(e -> e < 10).findFirst().ifPresent(System.out::println);
